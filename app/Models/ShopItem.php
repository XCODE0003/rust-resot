...
{
    protected $fillable = [
        'rs_id', 'item_id', 'category_id', 'server', 'servers', 'price', 'price_usd', 'discount_percent', 'amount', 'command', 'is_blueprint', 'is_command', 'is_item', 'wipe_block', 'status', 'variations','image', 'sort', 'can_gift',
