...
$short_name = "hort_name_" .app()->getLocale();
@endphp
...
@section('content')
  ...
  <div class="sb-popup__content spc">
    ...
    <div class="spc__mg">
      <img
        src="https://rustresort.com//storage/images/UlISwdu2J84n92wMbRZHCrlyVGXAU9lLdJ7TcOCv.png"
        alt="Employee Cobalt"
      />
    </div>
    <div class="spc__title">EMPLOYEE COBAT</div>
    <div class="spc__text">
      Это какое-то небольшое описание предмета, буквально несколько строк
      какого-то текста!
    </div>
    <div class="spc__info">
        ...
        <div class="spc__info--items">
            <div class="spc__info--items__item">
                <div class="spc__info----num">x10000</div>
                <img src="/images/spc-img-1.png" alt="spc-img">
                 <div class="spc__info--items__item--help"> Пропускает обычных игроков и ставит Вас ближе к началу очереди, после других игроков с приоритетом </div>
            </div>
            <div class="spc__info--items__item"
                ><div class="spc__info----num">x10000</div>
                <img src="/images/spc-img-2.png" alt="spc-img"><div class="spc__info--items__item--help"> Пропускает обычных игроков и ставит Вас ближе к началу очереди, после других игроков с приоритетом </div>
            </div>
            <div class="spc__info--items__item">
                <div class="spc__info----num">x10000</div>
                <img src="/images/spc-img-3.png" alt="spc-img"><div class="spc__info--items__item--help"> Пропускает обычных игроков и ставит Вас ближе к началу очереди, после других игроков с приоритетом </div>
            </div>
            <div class="spc__info--items__item">
                <div class="spc__info----num">x10000</div>
                <img src="/images/spc-img-4.png" alt="spc-img"><div class="spc__info--items__item--help"> Пропускает обычных игроков и ставит Вас ближе к началу очереди, после других игроков с приоритетом </div>
            </div>
            <div class="spc__info--items__item">
                <div class="spc__info----num">x10000</div>
                <img src="/images/spc-img-5.png" alt="spc-img"><div class="spc__info--items__item--help"> Пропускает обычных игроков и ставит Вас ближе к началу очереди, после других игроков с приоритетом </div>
            </div>
            <div class="spc__info--items__item">
                <div class="spc__info----num">x10000</div>
                <img src="/images/spc-img-6.png" alt="spc-img"><div class="spc__info--items__item--help"> Пропускает обычных игроков и ставит Вас ближе к началу очереди, после других игроков с приоритетом </div>
            </div>
            <div class="spc__info--items__item">
                <div class="spc__info----num">x10000</div>
                <img src="/images/spc-img-7.png" alt="spc-img"><div class="spc__info--items__item--help"> Пропускает обычных игроков и ставит Вас ближе к началу очереди, после других игроков с приоритетом </div>
            </div>
            <div class="spc__info--items__item">
                <div class="spc__info----num">x10000</div>
                <img src="/images/spc-img-8.png" alt="spc-img"><div class="spc__info--items__item--help"> Пропускает обычных игроков и ставит Вас ближе к началу очереди, после других игроков с приоритетом </div>
            </div>
        </div>
    </div>
     <div class="spc__info">
        ...
        <div class="spc__info--items">
            <div class="spc__info--items__item">
                <div class="spc__info----num">x10000</div>
                <img src="/images/spc-img-1.png" alt="spc-img"><div class="spc__info--items__item--help"> Пропускает обычных игроков и ставит Вас ближе к началу очереди, после других игроков с приоритетом </div>
            </div>
            <div class="spc__info--items__item">
                <div class="spc__info----num">x10000</div>
                <img src="/images/spc-img-2.png" alt="spc-img"><div class="spc__info--items__item--help"> Пропускает обычных игроков и ставит Вас ближе к началу очереди, после других игроков с приоритетом </div>
    ...
    <div class="spc__gift">
      <div class="spc-gift__text"><span></span>Купить в подарок</div>
      <div class="spc-gift__user">
        <input
          ...
          value=""
        />
        <p>*Вы сделаете подарок этому пользователю</p>
      </div>
    </div>

    <div class="spc__days">
      <div class="spc__text">Срок:</div>
      <div class="spc-days__day">
        <div class="spc-days-day__select">
          <select class="spcdds__variation">
    ...
    <div class="spc__price">
      <div class="spc-price__text">Стоимость:</div>
      <div class="spc-price__value">650.00 руб.</div>
    </div>

    <a
      class="spc__buy"
      data-itemid="5"
      data-itemname="Employee Cobalt"
      data-itemprice="650.00"
      data-varid="7"
      >Купить
    </a>
  </div>
            ...
            <div class="shop-item shop-item--special">
                ...
                <div class="shop-item-list">
                    ...
                    @foreach($shopitems as $shopitem)
                        <div class="item">
                            <div class="shop-item-buy sib-special sibc-special">
                                ...
                                <div class="shop-item-buy__content">
                                    ...
                                    <div class="shop-item-buy__content--price">
                                        <div class="shop-item-buy__content--price--cost">
                                            <span class="buy-item-price">@if(app()->getLocale() == 'ru'){{ $shopitem->price }}@else{{ $shopitem->price_usd }}@endif</span> @if(app()->getLocale() == 'ru'){{__('₽')}}@else{{ 'USD' }}@endif
                                        </div>
                                    </div>
    ...
    <div class="buying-item-modal balance-modal modal spbim">
