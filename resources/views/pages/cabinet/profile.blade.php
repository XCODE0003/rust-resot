             ...
             --}}
              ...
              <div class="styles__Method-sc-ena6u4-3 payment-item gcQxa-d" data-payment_id="46">
                <div
                        ...
                        fill="inherit"
                >
                  <img src="/images/payment-logos/cryptocloud.png">
                </div>
              </div>

              <div class="styles__Method-sc-ena6u4-3 payment-item gcQxa-d" data-payment_id="22">
                <div
                        class="styles__Icon-sc-h5vgtd-0 gpvUmb styles__MethodIcon-sc-ena6u4-4 kDTdJM"
                        fill="inherit"
                >
                  <div style="display: flex; align-items: center; justify-content: center; height: 100%; font-weight: bold; color: #333; font-size: 14px;">
                    Pally.info
                  </div>
                </div>
              </div>

              <div class="styles__Method-sc-ena6u4-3 payment-item gcQxa-d" data-payment_id="23">
                <div
                        class="styles__Icon-sc-h5vgtd-0 gpvUmb styles__MethodIcon-sc-ena6u4-4 kDTdJM"
                        fill="inherit"
                >
